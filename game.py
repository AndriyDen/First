...
pygame.display.set_caption('Бойовий Гусак')
...
player_rect = pygame.Rect(0, 345, *player_size)   # player.get_rect()
...
def create_enemy():
    ...
    enemy_rect = pygame.Rect(WIDTH, random.randint(50, HEIGHT-110), *enemy_size)
...
def create_bonus():
    ...
    # bonus.fill((211, 5, 57))
    bonus_rect = pygame.Rect(random.randint(100, WIDTH-160), 0, *bonus_size)
